...
- Some Reader Preferences such as language, running head, progression, navigation arrows and scroll affordances can now be set through a new Reader Settings Panel
